...
public class FakeUserProfileDataStore {
    ...
    static {
        USER_PROFILES.add(new UserProfile(UUID.fromString("adb17c03-1b3d-4140-bb7a-a1ca18a24bdd"), "janetjones", password, null));
        USER_PROFILES.add(new UserProfile(UUID.fromString("02e76c8b-c52f-4c12-9bd1-4a0934943aea"), "antoniojunior", password, null));
    }
